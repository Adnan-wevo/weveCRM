...
use App\Jobs\AccessControl\ImportUsersJob;
...
class ImportExportModal extends Component
{
    ...
    public function previewImport(): void
    {
        ...
        $rows = Excel::toCollection(new UsersImport, $this->uploadedFile)->first();
        ...
        foreach ($rows as $i => $row) {
            ...
            $errors = UsersImport::validateRow($rowArray, $i + 2);
    ...
    public function confirmImport(): void
    {
        ...
        $base = $tenantId ? "{$tenantId}/access-control/users/imports" : 'access-control/users/imports';
        ...
        ImportUsersJob::dispatch($path, $this->importJobId, (int) auth()->id());
    ...
    public function export(): void
    {
        ...
        ExportUsersJob::dispatch($this->exportJobId, (int) auth()->id(), tenancy()->initialized ? tenant('id') : null);
    ...
    {
        return view('accesscontrol::livewire.users.import-export-modal');
    }
}
