<flux:modal wire:model="show" class="w-full max-w-2xl">
    ...
    <div class="mb-5">
        <flux:heading size="lg">{{ __('Import / Export Permissions') }}</flux:heading>
        <flux:text class="text-zinc-500">
            {{ __('Export existing permissions to a spreadsheet or import new permissions from a file.') }}
        </flux:text>
    </div>
        ...
        <div class="space-y-6">
            ...
            <div class="rounded-lg border border-zinc-200 p-4 dark:border-zinc-700">
                ...
                <flux:text class="mb-4 text-sm text-zinc-500">
                    {{ __('Download all permissions as an Excel spreadsheet.') }}
                </flux:text>
            ...
            <div class="rounded-lg border border-zinc-200 p-4 dark:border-zinc-700">
                ...
                <flux:text class="mb-1 text-sm text-zinc-500">
                    {{ __('Upload a CSV or Excel file to create new permissions. Expected columns:') }}
                </flux:text>
                <p class="mb-4 font-mono text-xs text-zinc-400">name, guard_name</p>
