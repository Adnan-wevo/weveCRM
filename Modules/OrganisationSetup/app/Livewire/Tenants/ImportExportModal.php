...
use Modules\OrganisationSetup\Jobs\ImportTenantsJob;
...
class ImportExportModal extends Component
{
    ...
    public function previewImport(): void
    {
        ...
        $rows = Excel::toCollection(new TenantsImport, $this->uploadedFile)->first();
        ...
        foreach ($rows as $i => $row) {
            ...
            $errors = TenantsImport::validateRow($rowArray, $i + 2);
    ...
    public function confirmImport(): void
    {
        ...
        $base = $tenantId ? "{$tenantId}/organisation-setup/tenants/imports" : 'organisation-setup/tenants/imports';
        ...
        ImportTenantsJob::dispatch($path, $this->importJobId, (int) auth()->id());
    ...
    public function export(): void
    {
        ...
        ExportTenantsJob::dispatch($this->exportJobId, (int) auth()->id(), tenancy()->initialized ? tenant('id') : null);
    ...
    {
        return view('organisationsetup::livewire.tenants.import-export-modal');
    }
}
