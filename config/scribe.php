...
return [
    ...
    'description' => 'REST API for '.config('app.name').'. Authenticate using a Sanctum Bearer token obtained from POST /api/v1/auth/token.',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => 'This documentation covers all available API endpoints. Authenticate using a Bearer token obtained from the **POST /api/v1/auth/token** endpoint.',
